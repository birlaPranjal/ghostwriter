...
export default function SignInPage() {
  ...
  const handleEmailSignIn = async (e: React.FormEvent) => {
    ...
    try {
      await signIn("email", { email: (e.target as any).email.value, callbackUrl: "/dashboard" })
    } catch (error) {
      ...
      >
        <Card className="bg-gradient-to-br from-purple-950/20 to-black border-purple-900/30">
          <CardHeader className="text-center">
            ...
            <CardTitle className="text-2xl ghost-glow">Welcome Back</CardTitle>
            <p className="text-gray-400">Sign in to continue your writing journey</p>
          </CardHeader>
